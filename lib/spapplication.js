...
function (_VisualDivElement) {
  ...
  _createClass(WindowContainer, [{
    ...
    value: function createChildren() {
      ...
      var width = this.definition.width <= 0 ? window.screen.width : this.definition.width;
      var height = this.definition.height <= 0 ? window.screen.height : this.definition.height;
